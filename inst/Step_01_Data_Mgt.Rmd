...
### Missingness Status for Earliest SAK Start of Testing Window 
...
with partial *WDate* information. We are not not identified any reasonable and
defensible method for imputing precise *WDate* values for these offenders.
Therefore, we have excluded them from the sample analyzed for this paper
trimming the *SPDCHRE* dataset down to just those offenders who have a known
*WDate* and save the results as the *SPDCHREW* dataset.
