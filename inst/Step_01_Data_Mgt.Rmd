...
For the paper, we need to identify the data of the earliest SAK associated with 
each offender who has criminal history data and store that as a new dataset. 
Along the way, we need to do several intermediate tasks. 
...
offenders for whom we have criminal history data. 
...
Next, we need to figure out how many SAKs are associated with each offender and 
merge that information back into SPDCHR as a new variable. 
