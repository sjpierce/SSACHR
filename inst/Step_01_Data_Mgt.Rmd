...
identified or that were not arrests for one of the 12 crime categories of 
interest leaves `r nrow(ARREW)` arrest offense records in *ARREW*. Table 
...
FN <- paste("Only arrest offense records for incidents with valid testing",
            "window start dates and offenses among the 12 crime categories",
