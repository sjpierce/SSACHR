...
SPDCHREW %>% 
  ...
  mutate(# Classify incidents as before, during, or after the testing window. 
         IWhen = case_when(
           ...
           OID_IID == IID ~ "During TW",
           # Otherwise, compare IDate to TWindow to determine if incident was in
           # the window. 
           IDate < int_start(TWindow) ~ "Before TW",
           IDate %within% TWindow ~ "During TW",
           IDate > int_end(TWindow) ~ "After TW"),
