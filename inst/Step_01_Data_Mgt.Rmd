...
row per offender per crime category to facilitate analyses we added to respond 
...
Sexual_Crimes   <- c("HXCat12_5", "HXCat12_3")
Violent_Crimes  <- c("HXCat12_2", "HXCat12_3", "HXCat12_7", "HXCat12_9", "HXCat12_12")
Property_Crimes <- c("HXCat12_1", "HXCat12_4", "HXCat12_8")
Other_Crimes    <- c("HXCat12_6", "HXCat12_11")
...
IDNEWL %>% 
  ...
  pivot_longer(data = ., cols = starts_with("HXCat12_"), names_to = "Variable",
               values_to = "Count") %>%
  mutate(VLabel = case_when(Variable == "HXCat12_Count" ~ "Crime Category",
         ...
         VOrder = case_when(Variable == "HXCat12_Count" ~ 0,
                            Variable == "HXCat12_5" ~ 1,
                            Variable == "HXCat12_10" ~ 2,
                            Variable == "HXCat12_2" ~ 3,
                            Variable == "HXCat12_3" ~ 4,
                            Variable == "HXCat12_7" ~ 5,
                            Variable == "HXCat12_9" ~ 6,
                            Variable == "HXCat12_12" ~ 7,
                            Variable == "HXCat12_1" ~ 8,
                            Variable == "HXCat12_4" ~ 9,
                            Variable == "HXCat12_8" ~ 10,
                            Variable == "HXCat12_6" ~ 11,
                            Variable == "HXCat12_11" ~ 12)) ->
  IDNEWA
```
