...
SPDCHREW %>% 
  ...
  # Retain only variables we need, in sensible order. 
  select(all_of(c(names(IDN), "Age16Date", "AgeWDate", "ESAKID", "ESAK_IID", "WDate", 
                  "TWindow", "Turn16_Before_WDate", "Turn16_After_WDate", 
                  "DCDate", "End_TWindow_Before_DC", "OWindow", "BWindow", 
                  "AWindow", "Years_Overall", "Years_Before", "Years_During", 
                  "Years_After"))) ->
  IDNEW
```
