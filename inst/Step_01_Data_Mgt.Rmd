...
INCEW %>% 
  ...
  mutate(NINC12_Before = ifelse(Years_Before == 0, yes = NA, 
                                no = NINC12_Before)) %>%
  mutate(NINC12_During = ifelse(Years_During == 0, yes = NA, 
                                no = NINC12_During)) ->
  IDNEW
```
...
ARREW %>% 
  ...
  # Set count variables with values of 0 to NA when that period was unobserved.  
  mutate(NARR12_Before = ifelse(Years_Before == 0, yes = NA, 
                                no = NARR12_Before)) %>%
  mutate(NARR12_During = ifelse(Years_During == 0, yes = NA, 
                                no = NARR12_During)) %>%  
...
CHGEW %>% 
  ...
  # Set count variables with values of 0 to NA when that period was unobserved.  
  mutate(NCHG12_Before = ifelse(Years_Before == 0, yes = NA, 
                                no = NCHG12_Before)) %>%
  mutate(NCHG12_During = ifelse(Years_During == 0, yes = NA, 
                                no = NCHG12_During)) %>%  
...
JUDEW %>% 
  ...
  # Set count variables with values of 0 to NA when that period was unobserved.  
  mutate(NJUD12_Before = ifelse(Years_Before == 0, yes = NA, 
                                no = NJUD12_Before)) %>%
  mutate(NJUD12_During = ifelse(Years_During == 0, yes = NA, 
                                no = NJUD12_During)) %>%  
...
CONEW %>% 
  ...
  # Set count variables with values of 0 to NA when that period was unobserved.  
  mutate(NCON12_Before = ifelse(Years_Before == 0, yes = NA, 
                                no = NCON12_Before)) %>%
  mutate(NCON12_During = ifelse(Years_During == 0, yes = NA, 
                                no = NCON12_During)) %>%  
