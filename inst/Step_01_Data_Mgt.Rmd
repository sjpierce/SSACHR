...
read_sav(here::here("inst/extdata/SSA_ARR_Arrests_Imputed_2018-09-03.sav"), 
  ...
  var_labels(ACat12_1   = "Arrested for arson",
             ...
             ACat12_11  = "Arrested for traffice & ordinances",
...
read_sav(here::here("inst/extdata/SSA_CHG_PA_Charges_Imputed_2018-09-03.sav"), 
  ...
  var_labels(CCat12_1   = "Charged with arson",
             CCat12_2   = "Charged with assault - DV, stalking",
             CCat12_3   = "Charged with assault - non-sexual, non-DV",
             CCat12_4   = "Charged with burglary",
             CCat12_5   = "Charged with criminal sexual conduct",
             CCat12_6   = "Charged with drug crime",
             CCat12_7   = "Charged with homicide",
             CCat12_8   = "Charged with larceny/theft/fraud",
             CCat12_9   = "Charged with robbery", 
             CCat12_10  = "Charged with sex crime, other excluding CSC",
             CCat12_11  = "Charged with traffice & ordinances",
             CCat12_12  = "Charged with weapons",
             CCat12_999 = "Charged with excluded user-missing",
             CCat12_Any = "Charged with any of 12 main crime categories") ->
  CHG
```
...
read_sav(here::here("inst/extdata/SSA_JUD_Judicial_Charges_Imputed_2018-09-03.sav"), 
  ...
  var_labels(JCat12_1   = "Adjudicated for arson",
             ...
             JCat12_11  = "Adjudicated for traffice & ordinances",
...
JUD %>% 
  ...
  mutate(NCON = 1) %>% 
  # Add variable label. 
  var_labels(JCat12_1   = "Convicted of arson",
             JCat12_2   = "Convicted of assault - DV, stalking",
             JCat12_3   = "Convicted of assault - non-sexual, non-DV",
             JCat12_4   = "Convicted of burglary",
             JCat12_5   = "Convicted of criminal sexual conduct",
             JCat12_6   = "Convicted of drug crime",
             JCat12_7   = "Convicted of homicide",
             JCat12_8   = "Convicted of larceny/theft/fraud",
             JCat12_9   = "Convicted of robbery", 
             JCat12_10  = "Convicted of sex crime, other excluding CSC",
             JCat12_11  = "Convicted of traffice & ordinances",
             JCat12_12  = "Convicted of weapons",
             JCat12_999 = "Convicted of excluded user-missing",
             JCat12_Any = "Convicted of any of 12 main crime categories",
