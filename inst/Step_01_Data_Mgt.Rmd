...
# Table caption.
TCap <- paste("Frequency Distribution of When the Associated Incident Occurred",
              "Relative to Testing Window for Arrest Offense Records")
# Footnote text.
...
The next step is to merge variables from *INCEW* onto the arrest data in *CHG*
...
The original *CHG* tibble had `r nrow(CHG)` prosecutor charge records. Dropping the
records associated with offenders whose earliest testing window could not be
...
# Table caption.
TCap <- paste("Frequency Distribution of When the Associated Incident Occurred",
              "Relative to Testing Window for Prosecutor Charge Records")
# Footnote text.
...
# Table caption.
TCap <- paste("Frequency Distribution of When the Associated Incident Occurred",
              "Relative to Testing Window for Judicial Charge Records")
# Footnote text.
