...
SPDCHREW %>% 
  ...
  mutate(
    ...
    AgeTWStart = interval(DOB, WDate)/dyears(1),
    # Offender age at end of earliest SAK testing window
    AgeTWEnd = interval(DOB, WDate + 118)/dyears(1),
    ...
    DurationBP = BWindow/dyears(1),
    # Duration of testing window period (years)
    DurationDP = TWindow/dyears(1),
    # Duration of after testing window period (years)
    DurationAP = AWindow/dyears(1)) %>% 
  var_labels(
    Age16Date = "Offender 16th Birthday (Date Turned Age 16 Years)",
