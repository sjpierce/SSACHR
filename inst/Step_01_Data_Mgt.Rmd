...
Merging the testing window variables onto the *IDN* data in an obvious next
...
SPDCHREW %>% 
  ...
  select(all_of(c(names(IDN), "ESAKID", "WDate", "TWindow"))) %>% 
...
identified leaves `r nrow(ARREW`) arrest offense records in *ARREW*.
