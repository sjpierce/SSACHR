...
Here we aggregate the dummy coded crime category variables from the record level
to the incident level to flag presence or absence of each crime category on the
incident.
