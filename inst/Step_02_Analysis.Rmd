...
record type and when the incident occurred, while Table \ref{tab:freq_HXCat12_1} 
...
the incident occurred, while Table \ref{tab:freq_HXCat12_2} shows the frequency
...
by CHR record type and when the incident occurred, while Table
\ref{tab:freq_HXCat12_3} shows the frequency distributions underlying those
summaries.
...
by CHR record type and when the incident occurred, while Table
\ref{tab:freq_HXCat12_4} shows the frequency distributions underlying those
summaries.
...
sexual conduct incidents by CHR record type and when the incident occurred,
while Table \ref{tab:freq_HXCat12_5} shows the frequency distributions
underlying those summaries.
...
CHR record type and when the incident occurred, while Table
...
by CHR record type and when the incident occurred, while Table
\ref{tab:freq_HXCat12_7} shows the frequency distributions underlying those
summaries.
...
theft, or fraud incidents by CHR record type and when the incident occurred,
while Table \ref{tab:freq_HXCat12_8} shows the frequency distributions
underlying those summaries.
...
\ref{tab:describe_robbery} summarizes the counts of unique robbery incidents by
CHR record type and when the incident occurred, while Table
\ref{tab:freq_HXCat12_9} shows the frequency distributions underlying those
summaries.
...
by CHR record type and when the incident occurred, while Table 
\ref{tab:freq_HXCat12_10} shows the frequency
distributions underlying those summaries.
...
incidents by CHR record type and when the incident occurred, while Table
