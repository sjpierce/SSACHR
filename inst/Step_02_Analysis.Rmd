...
incident associated with an assault (involving domestic violence and/or stalking)
arrest, charge, or conviction. Table \ref{tab:describe_assaultdvvars} summarizes 
the 
counts of unique assault incidents by CHR record type and when the incident
occurred. In the subsections below, Tables \ref{tab:freq_ACat12_2},
...
\ref{tab:describe_assaultdvvars}.

```{r describe_assaultdvvars}
# Table caption. 
