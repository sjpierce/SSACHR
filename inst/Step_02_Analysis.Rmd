...
Only `r CSC_CHR_History` 
(`r round(100*CSC_CHR_History/nrow(IDNEW), digits = 0)`\%) of these suspected 
sexual offenders had criminal histories containing at least one CSC arrest, 
