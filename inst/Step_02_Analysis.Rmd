...
Tables \ref{tab:freq_NINC}, \ref{tab:freq_NARR}, \ref{tab:freq_NCHG}, 
\ref{tab:freq_NJUD}, and \ref{tab:freq_NCON} show the frequency distributions
...
countvars  <- c("ACat12_1", "CCat12_1", "JCat12_1", "HXCat12_1")
counttypes <- c("Arrested", "Charged", "Convicted", "Arrested, Charged, or Convicted")
