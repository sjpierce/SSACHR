...
incident associated with an arrest, charge, or conviction for criminal sexual conduct. Table
\ref{tab:describe_csc} summarizes the counts of unique criminal sexual conduct incidents by CHR
record type and when the incident occurred. In the subsections below, Tables
\ref{tab:freq_ACat12_5}, \ref{tab:freq_CCat12_5}, \ref{tab:freq_JCat12_5}, and
\ref{tab:freq_HXCat12_5} show the frequency distributions underlying the
summaries in Table \ref{tab:describe_csc}.
...
\ref{tab:describe_drug} summarizes the counts of unique drug crime incidents by CHR
record type and when the incident occurred. In the subsections below, Tables
...
\ref{tab:describe_homicide} summarizes the counts of unique burglary incidents by CHR
record type and when the incident occurred. In the subsections below, Tables
\ref{tab:freq_ACat12_7}, \ref{tab:freq_CCat12_7}, \ref{tab:freq_JCat12_7}, and
\ref{tab:freq_HXCat12_7} show the frequency distributions underlying the
summaries in Table \ref{tab:describe_homicide}.
...
fraud. Table \ref{tab:describe_csc} summarizes the counts of unique larceny,
...
#### Arrested
Table \ref{tab:freq_ACat12_5} shows the frequency distributions for larceny,
...
#### Charged
Table \ref{tab:freq_CCat12_5} shows the frequency distributions for larceny,
...
#### Convicted
Table \ref{tab:freq_JCat12_5} shows the frequency distributions for larceny,
