...
csclabs <- c("No. of CSC incidents (arrested)", BDA, 
             "No. of CSC incidents (charged)", BDA,
             "No. of CSC incidents (convicted)", BDA)
...
IDNEW %>% 
  filter(ACat12_5 >= 1 | CCat12_5 >= 1 | JCat12_5 >= 1) %>% 
  nrow() -> 
  CSC_CHR_History
```
...
criminal histories containing at least one CSC arrest, charge, or conviction. 
