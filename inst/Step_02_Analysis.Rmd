...
```{r plot_Crime_full_width, fig.height = 8.5, fig.width = 7.5, fig.cap = FCap}
FCap <- paste("\\label{fig:plot_Crime_full_width}",
              "Distributions for Number of Incidents for Which Offender Was",
              "Arrested, Charged, or Convicted After the Testing Window",
              "By Crime Category.",
...
```{r plot_Crime_partial_width, fig.height = 8.5, fig.width = 7.5, fig.cap = FCap}
...
```{r plot_after_BCrime_full_width, fig.height = 5.75, fig.width = 7.5, fig.cap = FCap}
...
```{r plot_BCrime_partial_width, fig.height = 5.75, fig.width = 7.5, fig.cap = FCap}
...
Figure \ref{fig:plot_IYearsAfterTW} shows the distributions for the number of 
years elapsed between the end of the testing window and each incident that 
occurred after the window ended broken down by broader crime category. 

```{r plot_IYearsAfterTW, fig.height = 5.75, fig.width = 7.5, fig.cap = FCap}
FCap <- paste("\\label{fig:plot_IYearsAfterTW}",
              "Distributions for Years Elapsed Between End of Testing Window",
              "and Incdent Date for Incidents Where Offender Was",
              "Arrested, Charged, or Convicted After the Testing Window",
              "By Broader Crime Category.",
