...
proportion remaining instead more closely aligns with the number of potentially preventable incidents. We also improved the labeling of the axes and the figure
...
FCap <- paste("\\label{fig:plot_IYearsAfterTW_Crime_ecdf}",
              ...
              "Only incidents ocurring after the testing window are included.",
              "Each panel includes a line showing how the percentage of", 
              "incidents remaining declines over time (this line is the",
              "complement of the cumulative density function) above a strip",
              "plot with an overlaid boxplot.",
              "The strip plots show a dot for when each incident occurred,",
              "with positions jittered to reduce overlap. They show the raw",
              "data used to obtain the summary represented by the lines.",
              "The boxplots provide an additional summary of the raw data",
              "that highlight when 75%, 50%, and 25% of the incidents remain.")
