...
If you use Git (Torvalds et al., 2020) and have a GitHub account, just clone the
package to your computer using the usual Git commands. Otherwise, manually 
download a ZIP file and unzip its contents to a folder. Either way, the files
should end up in a folder called *SSACHR* on your computer. That folder is then
